...
class DonateDialog(MessageBoxBase):
    def __init__(self, parent=None):
        ...
        self.setup_ui()
        self.setWindowTitle(self.tr("Support Author"))

    def setup_ui(self):
        # 创建标题标签
        self.titleLabel = BodyLabel(self.tr("Thank You for Your Support"), self)

        # 创建说明文本
        self.descLabel = BodyLabel(
            self.tr(
                "Your support motivates me to continue working on this project!\nThank you for your love and support for open source!"
            ),
            self,
        )
        ...
        self.alipayLabel = BodyLabel(self.tr("Alipay"))
        ...
        self.wechatLabel = BodyLabel(self.tr("WeChat"))
