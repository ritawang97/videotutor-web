...
class WhisperAPISettingWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.setting_group = SettingCardGroup(self.tr("Whisper API Settings"), self)
        ...
        self.base_url_card = LineEditSettingCard(
            ...
            self.tr("Enter Whisper API Base URL"),
        ...
        self.language_card = ComboBoxSettingCard(
            ...
            FIF.LANGUAGE,
            self.tr("Original Language"),
            self.tr("Original language of audio"),
