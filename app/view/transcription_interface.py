...
class VideoInfoCard(CardWidget):
    ...
    def setup_info_layout(self) -> None:
        ...
        self.video_title = BodyLabel(self.tr("Please drag audio or video file"), self)
        ...
        self.resolution_info = self.create_pill_button(self.tr("Quality"), 110)
    ...
    def update_info(self, video_info: VideoInfo) -> None:
        ...
        self.resolution_info.setText(
            self.tr("Quality: ") + f"{video_info.width}x{video_info.height}"
        )
...
class TranscriptionInterface(QWidget):
    ...
    def _on_transcript_finished(self, task: TranscribeTask):
        ...
        if task.need_next_task:
            ...
            InfoBar.success(
                ...
                self.tr("Start Subtitle Optimization..."),
                duration=3000,
    ...
    def dropEvent(self, event):
        ...
        if self.is_processing:
            InfoBar.warning(
                self.tr("Warning"),
                self.tr("Processing, please wait for current task to complete"),
                duration=3000,
                parent=self,
            )
            return
        ...
        for file_path in files:
            ...
            if is_supported:
                ...
                InfoBar.error(
                    ...
                    self.tr("Please drag audio or video file"),
                    duration=3000,
                    parent=self,
                )
